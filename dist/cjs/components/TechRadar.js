...
var Radar_style_1 = require("../styles/Radar.style");
var Quadrant_1 = tslib_1.__importDefault(require("./Quadrant"));
...
var TechRadar = function (props) {
    ...
    var _a = (0, react_1.useContext)(ThemeContext_1.ThemeContext), fontSize = _a.fontSize, fontFamily = _a.fontFamily, colorScale = _a.colorScale;
    ...
    var getRandomCoordinates = function (rings, entry, angle, quadrant_delta, results, collisionCount) {
        ...
        // return data;
        return tslib_1.__assign(tslib_1.__assign({}, data), { collisionCount: collisionCount });
    };
    var points = processRadarData(props.quadrants, rings, data);
    return (react_1.default.createElement(ThemeContext_1.ThemeContext.Provider, { value: {
            ...
            colorScale: props.colorScaleIndex ? (0, ThemeContext_1.getColorScale)(props.colorScaleIndex) : colorScale,
            quadrantsConfig: props.quadrantsConfig || {},
        } },
        react_1.default.createElement(Radar_style_1.RadarContents, { width: width * RIGHT_EXTENSION, height: width, style: { margin: margin } },
            react_1.default.createElement("g", { transform: "translate(".concat(width / 2, ",").concat(width / 2, ")") }, props.quadrants.map(function (value, index) {
                // Get points that belong to this quadrant
                var filteredPoints = points.filter(function (element) { return element.quadrant === value; });
                return (react_1.default.createElement("g", { key: index },
                    react_1.default.createElement(Quadrant_1.default, { transform: "rotate(".concat((360 / props.quadrants.length) * index, ") translate(").concat(margin, ",").concat(margin, ")"), rotateDegrees: (360 / props.quadrants.length) * index, width: width - 2 * margin, index: index, rings: rings, points: filteredPoints, angle: angle, name: value, radiusDiminish: radiusDiminishConstant })));
            })))));
};
exports.default = TechRadar;
